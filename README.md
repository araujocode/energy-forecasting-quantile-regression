...
The final output of the training script includes a timestamped folder containing all the necessary plots to evaluate the models.
...
### Example Output Plots (Latest Run)

Below are the latest results generated by the training pipeline (from `report/figures/20250627-185612/`):

**Median Forecast (50th percentile):**

Predictions vs. Actuals:  
Shows how the median forecast tracks the real energy usage on the test set.

![Median Forecast Predictions](report/figures/20250627-185612/predictions_Median_Forecast%20(50th).png)

SHAP Summary Plot:  
Highlights the most important features influencing the median forecast.

![Median Forecast SHAP Summary](report/figures/20250627-185612/shap_summary_Median_Forecast%20(50th).png)

Training Curve:  
Displays the quantile loss on the validation set during training for the median model.

![Median Forecast Training Curve](report/figures/20250627-185612/training_curve_Median_Forecast%20(50th).png)

**Peak Forecast (90th percentile):**

Predictions vs. Actuals:  
Shows how the peak forecast captures high-consumption events on the test set.

![Peak Forecast Predictions](report/figures/20250627-185612/predictions_Peak_Forecast%20(90th).png)

SHAP Summary Plot:  
Highlights the most important features influencing the peak forecast.

![Peak Forecast SHAP Summary](report/figures/20250627-185612/shap_summary_Peak_Forecast%20(90th).png)

Training Curve:  
Displays the quantile loss on the validation set during training for the peak model.

![Peak Forecast Training Curve](report/figures/20250627-185612/training_curve_Peak_Forecast%20(90th).png)
